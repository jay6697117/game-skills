...
**For:** Claude Code
**Purpose:** Generate game-ready fixed-cell pixel-art character spritesheets with 4-way or 8-way animations from a text prompt or reference image, using the `codex-gateway-imagegen` skill for visual generation.

## What It Does

```text
"Use game-character-sprites to make a 64x64 knight with 8-direction walk and attack
animations from this image via codex-gateway-imagegen."
```
...
- `codex-gateway-imagegen` skill for visual generation; outputs must be available as local files for the bundled cleanup and validation scripts
